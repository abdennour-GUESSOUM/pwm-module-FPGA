...
HD_PWD='/home2/etudiants/master2/abdennour.guessoum/tp_pwm/tp_pwm.runs/design_1_pwm_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_pwm_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_pwm_0_4.tcl
